...
|Прозвішча                  |Семестр1| ДЗ  | ДЗ  |KP1  | КР2 |Семестр2|
|:------------------------------|:--:|:---:|----:|:---:|----:|----:|
|Асонов Дмитрий Геннадьевич     | 7  |     |     | 4   |     | 4  | 
|Богданович Вероника Викторовна | 7  |     |     | 8   |  6  | 5+0  |
|Давыденко Александра Викторовна| 5  |     |     | 2   |     | 4  |
|Демянович Владислав Павлович   | 9  |     |     |  8  |     | 4  |
|Киселев Артем Рональдович      | 6  |     |     | 2   | 6   | 5  |
|Линник Дмитрий Васильевич      | 8  |     |     | 5   | 6   | 5  |
|Савко Тимур Леонидович         | 6  |     |     |     | 7   | 6  |
|Станкевич Александр Олегович   | 7  |     |     | 7   | 8   | 6  |
|Семенович Роман                | 8  |     |     |     | 9   | 7+0.5  |
|Утлик Павел Дмитриевич         | 5  |     |     |     |     | 4  |
|Федосов Андрей Игоревич        | 9  |     |     | 7   |  8  | 7  |
|Шавеко Иван Геннадьевич        | 9  |     |     | 4   |  9  | 5  |
|Шишкарёв Иван Анатольевич      | 9  |     |     |     |     | 4+1  |
|Круковский Jn                  | 7  | ||||4|
----------------------------------
...
•	приватные поля     
•	деструктор (т.к. для тех, кто претендует на оценку >8 обязательно использование динамического выделения памяти под некоторые поля такие, как артикул, фамилия, название и т.п. *размер памяти НЕ ФИКСИРОВАННЫЙ, а нужного размера, чтобы точно вместить информацию*),        
•	конструкторы (по умолчанию, несколько – с параметрами), конструктор копирования,      
•	функции ввода, вывода членов класса (для тех, кто претендует на оценку >8 обязательно переопределение операторов вывода в cin и запись данных в двоичный файл),      
...
•	Для получения >8 баллов в main надо реализовать меню с пунктами (считать набор данных из файла, записать в файл, удалить одну (или несколько) запись из файла).      
...
**Посложнее**  
•	(Шишкарёв) В тексте удалить фрагменты, заключённые в круглые скобки (скобка может начинаться в одной строке, а заканчиваться -  другой. Могут быть вложенные скобки, но они всегда верно расставлены. Т.е. нет ситуации "(...(...)..()" ).     
